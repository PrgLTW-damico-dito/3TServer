...
const cs = `postgres://uswuxjorcktbzt:f70cdddab92c18f8807d4ef736aaaf78bbf0634bb0d17c6636825711642604ac@ec2-54-216-185-51.eu-west-1.compute.amazonaws.com:5432/d5sv4ha7uue8gb`;
const pool = new Pool({
    connectionString: cs,
...
exports.getUsers = (req, res) => {
    console.log("getUser");
    pool.query('SELECT id, username, stato FROM utente WHERE stato = $1',[1], (error, results) =>{
        if(error){
